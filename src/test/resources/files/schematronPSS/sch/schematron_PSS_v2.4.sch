...
<!--_______________________________________________________CONTROLLI SUI DIZIONARI_____________________________________________________________-->
		...
		<rule context="//hl7:statusCode">
			<let name="val_status" value="encode-for-uri(@code)"/>
			<assert test="count(@code)=0 or doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.6.1.5?code=',$val_status))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.5.2.8']">
			<let name="val_assdom" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.5.2.8?code=',$val_assdom))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.5.1052']">
			<let name="val_actsite" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.5.1052?code=',$val_actsite))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.1.11.19700']">
			<let name="obsIntoleranceType1" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.1.11.19700?code=',$obsIntoleranceType1))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.3']">
			<let name="reaz_int" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.3?code=',$reaz_int))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.6']">
			<let name="cri_obs" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.6?code=',$cri_obs))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.7']">
			<let name="problem_status" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.7?code=',$problem_status))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.8']">
			<let name="age" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.8?code=',$age))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.11.22.9']">
			<let name="val_allergies" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.11.22.9?code=',$val_allergies))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.9']">
			<let name="prob_obs" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.9?code=',$prob_obs))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.10']">
			<let name="prob_cron" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.10?code=',$prob_cron))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.11']">
			<let name="status_aller" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.11?code=',$status_aller))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.12']">
			<let name="proc_trap" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.12?code=',$proc_trap))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.13']">
			<let name="author_code" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.13?code=',$author_code))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.14']">
			<let name="enc_code" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.14?code=',$enc_code))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.15']">
			<let name="cap_mot" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.15?code=',$cap_mot))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.16']">
			<let name="organi_manc9" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.16?code=',$organi_manc9))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.17']">
			<let name="organi_manc10" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.17?code=',$organi_manc10))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.2.9.77.22.11.18']">
			<let name="trapianti" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.2.9.77.22.11.18?code=',$trapianti))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.11.22.15']">
			<let name="medication" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.11.22.15?code=',$medication))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.11.22.17']">
			<let name="prob" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.11.22.17?code=',$prob))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.11.22.36']">
			<let name="procedures" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.11.22.36?code=',$procedures))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.11.22.61']">
			<let name="devices" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.11.22.61?code=',$devices))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.1.11.1']">
			<let name="gender" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.1.11.1?code=',$gender))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.5.1']">
			<let name="gender1" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.5.1?code=',$gender1))//result='true'"
		...
		<rule context="//*[@codeSystem='2.16.840.1.113883.5.111']">
			<let name="roleCode" value="encode-for-uri(@code)"/>
			<assert test="doc(concat('http://###PLACEHOLDER_URL###/v1/validate-terminology/2.16.840.1.113883.5.111?code=',$roleCode))//result='true'"
